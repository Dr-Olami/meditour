...
const egypt: CountryMetadata = {
  ...
  recommendedCities: [
    {
      name: 'Bangalore',
      flightTime: '6.5 hours from Cairo',
      directFlights: false,
      airlines: ['Connecting via Dubai'],
  ...
  heroSubtitle:
    'Flights from Cairo. Arabic-speaking coordinators. Halal facilities. Save 40–60% vs Turkey and Germany.',
  metaDescription:
    'Affordable medical treatment in India for Egyptian patients. Arabic support, halal food, save 40–60% on cardiac, cancer, orthopedic care at JCI hospitals. Free consultation.',
  introParagraph:
    'Patients from Cairo and Alexandria travel to India for cardiac surgery, cancer treatment, orthopedics, and transplants — with Arabic-speaking coordinators, halal food, and JCI-accredited hospitals.',
...
const iran: CountryMetadata = {
  ...
  recommendedCities: [
    {
      name: 'Bangalore',
      flightTime: '6 hours from Tehran',
      directFlights: false,
      airlines: ['Connecting via Dubai or Sharjah'],
      specialties: ['Transplant', 'Cardiac', 'Orthopedics', 'Cancer'],
    },
    {
      name: 'Mumbai',
      flightTime: '5 hours from Tehran',
      directFlights: false,
      airlines: ['Connecting via Dubai'],
      specialties: ['Cancer', 'Cardiac', 'Cosmetic'],
    },
  ...
  heroSubtitle:
    'Flights from Tehran. Persian-speaking coordinators. Halal facilities. Save 30–50% vs Turkey and UAE.',
  metaDescription:
    'Affordable medical treatment in India for Iranian patients. Persian/Farsi support, halal food, save 30–50% on cardiac, cancer, orthopedic care at JCI hospitals. Free consultation.',
  introParagraph:
    'Patients from Tehran, Mashhad, and Isfahan travel to India for cardiac surgery, cancer treatment, orthopedics, and transplants — with Persian-speaking coordinators, halal food, and JCI-accredited hospitals.',
...
const iraq: CountryMetadata = {
  ...
  recommendedCities: [
    {
      name: 'Bangalore',
      flightTime: '6 hours from Baghdad',
      directFlights: false,
      airlines: ['Connecting via Dubai'],
      specialties: ['Transplant', 'Cardiac', 'Orthopedics', 'Cancer'],
    },
    ...
    {
      name: 'Mumbai',
      flightTime: '5.5 hours from Baghdad',
      directFlights: false,
      airlines: ['Connecting via Dubai'],
      specialties: ['Cancer', 'Cardiac', 'Cosmetic'],
    },
  ...
  heroSubtitle:
    'Flights from Baghdad and Erbil. Arabic and Kurdish support. Halal facilities. Save 50–70% vs Turkey.',
  metaDescription:
    'Affordable medical treatment in India for Iraqi patients. Arabic/Kurdish support, halal food, save 50–70% on cardiac, cancer, orthopedic care at JCI hospitals. Free consultation.',
  introParagraph:
    'Patients from Baghdad, Basra, and Erbil travel to India for cardiac surgery, cancer treatment, orthopedics, and transplants — with Arabic and Kurdish language support, halal food, and JCI-accredited hospitals.',
...
const jordan: CountryMetadata = {
  ...
  heroSubtitle:
    'Flights from Amman. Arabic-speaking coordinators. Halal facilities. Save 40–60% vs Turkey.',
  metaDescription:
    'Affordable medical treatment in India for Jordanian patients. Arabic support, halal food, save 40–60% on cardiac, cancer, orthopedic care at JCI hospitals. Free consultation.',
  introParagraph:
    'Patients from Amman travel to India for cardiac surgery, cancer treatment, orthopedics, and transplants — with Arabic-speaking coordinators, halal food, and JCI-accredited hospitals.',
...
const yemen: CountryMetadata = {
  ...
  recommendedCities: [
    {
      name: 'Bangalore',
      flightTime: '7 hours from Sanaa',
      directFlights: false,
      airlines: ['Connecting via Dubai or Cairo'],
      specialties: ['Transplant', 'Cardiac', 'Orthopedics', 'Cancer'],
    },
    {
      name: 'Mumbai',
    ...
    {
      name: 'Delhi',
      flightTime: '6.5 hours from Sanaa',
      directFlights: false,
      airlines: ['Connecting via Dubai'],
      specialties: ['Cardiac', 'Cancer', 'Orthopedics'],
    },
  ...
  heroSubtitle:
    'Flights from Sanaa and Aden. Arabic-speaking coordinators. Halal facilities. Save 60–80% vs local options.',
  metaDescription:
    'Affordable medical treatment in India for Yemeni patients. Arabic support, halal food, save 60–80% on cardiac, cancer, orthopedic care at JCI hospitals. Free consultation.',
  introParagraph:
    'Patients from Sanaa and Aden travel to India for cardiac surgery, cancer treatment, orthopedics, and transplants — with Arabic-speaking coordinators, halal food, and JCI-accredited hospitals.',

  currency: { code: 'YER', symbol: '﷼', exchangeRate: 250, name: 'Yemeni Rial' },
};

export const middleEastCountriesPart2: CountryMetadata[] = [egypt, iran, iraq, jordan, yemen];
