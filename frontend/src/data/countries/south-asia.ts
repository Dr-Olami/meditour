...
const bangladesh: CountryMetadata = {
  ...
  recommendedCities: [
    {
      name: 'Kolkata',
      flightTime: '1 hour from Dhaka',
      directFlights: true,
      airlines: ['Biman Bangladesh', 'IndiGo', 'Air India'],
      specialties: ['Cardiac', 'Oncology', 'Neurosurgery'],
    },
    {
      name: 'Bangalore',
      flightTime: '3 hours from Dhaka',
      directFlights: true,
      airlines: ['Biman Bangladesh', 'IndiGo'],
  ...
  heroSubtitle:
    'Direct flights from Dhaka. Bengali-speaking coordinators. Save 60–80% on treatments. Trusted by 5,000+ families.',
  metaDescription:
    'Affordable medical treatment in India for Bangladeshi patients. Save 60–80% on cardiac, orthopedic, cancer care with visa support, Bengali staff, and JCI hospitals. Free consultation.',
  introParagraph:
    'Patients from Dhaka, Chittagong, and Sylhet travel to India for cancer care, cardiac surgery, transplants, and orthopedics — with Bengali or English support, nearby metro options, medical visa help, and competitive package pricing.',
...
const afghanistan: CountryMetadata = {
  ...
  recommendedCities: [
    {
      name: 'Delhi',
      flightTime: '2 hours from Kabul',
      directFlights: true,
      airlines: ['Ariana Afghan Airlines', 'Kam Air', 'Air India'],
      specialties: ['Cardiac', 'Cancer', 'Trauma', 'Orthopedics'],
    },
    {
      name: 'Bangalore',
      flightTime: '4 hours from Kabul',
      directFlights: false,
      airlines: ['Connecting via Delhi'],
      specialties: ['Transplant', 'Cardiac', 'Cancer'],
    },
    {
      name: 'Mumbai',
      flightTime: '3 hours from Kabul',
      directFlights: true,
      airlines: ['Kam Air'],
      specialties: ['Cancer', 'Cardiac', 'Orthopedics'],
    },
  ],
  ...
  heroSubtitle:
    'Direct flights from Kabul. Dari and Pashto interpreters. Save 70–85% on treatments. Trusted by 800+ Afghan families.',
  metaDescription:
    'Affordable medical treatment in India for Afghan patients. Save 70–85% on cardiac, cancer, orthopedic care with visa support, Dari/Pashto interpreters, and JCI hospitals. Free consultation.',
  introParagraph:
    'Patients from Kabul, Herat, and Kandahar travel to India for cardiac surgery, cancer treatment, orthopedics, and trauma care — with Dari and Pashto language support, medical visa assistance, and culturally sensitive care.',
...
const nepal: CountryMetadata = {
  ...
  recommendedCities: [
    {
      ...
      flightTime: '1.5 hours from Kathmandu',
      directFlights: true,
      airlines: ['IndiGo', 'Air India', 'Nepal Airlines'],
      specialties: ['Cardiac', 'Cancer', 'Neurosurgery'],
    },
    {
      name: 'Bangalore',
      flightTime: '3 hours from Kathmandu',
      directFlights: true,
    ...
    {
      name: 'Varanasi',
      flightTime: '1 hour from Kathmandu',
      directFlights: false,
      airlines: ['Connecting via Delhi'],
  ...
  heroSubtitle:
    'Direct flights from Kathmandu. Visa-free travel. Nepali and Hindi-speaking coordinators. Save 50–70% on treatments.',
  metaDescription:
    'Affordable medical treatment in India for Nepali patients. Visa-free travel, Nepali/Hindi support, save 50–70% on cardiac, cancer, orthopedic care at JCI hospitals. Free consultation.',
  introParagraph:
    'Patients from Kathmandu, Pokhara, and across Nepal travel to India for cardiac surgery, cancer treatment, transplants, and orthopedics — benefiting from visa-free travel, Hindi/Nepali language support, and world-class hospitals at a fraction of the cost.',
...
const sriLanka: CountryMetadata = {
  ...
  recommendedCities: [
    {
      ...
      flightTime: '1.5 hours from Colombo',
      directFlights: true,
      airlines: ['IndiGo', 'SriLankan Airlines', 'Air India'],
      specialties: ['Cardiac', 'Cancer', 'Orthopedics', 'Transplant'],
    },
    {
      name: 'Bangalore',
      flightTime: '1.5 hours from Colombo',
    ...
    {
      name: 'Kochi',
      flightTime: '1 hour from Colombo',
      directFlights: true,
      airlines: ['IndiGo', 'SriLankan Airlines'],
  ...
  heroSubtitle:
    'Direct flights from Colombo. Sinhala and Tamil support. Save 40–60% on treatments. Trusted by 1,200+ Sri Lankan families.',
  metaDescription:
    'Affordable medical treatment in India for Sri Lankan patients. Save 40–60% on cardiac, cancer, orthopedic care with visa support, Sinhala/Tamil staff, and JCI hospitals. Free consultation.',
  introParagraph:
    'Patients from Colombo, Kandy, and across Sri Lanka travel to India for cardiac surgery, cancer treatment, transplants, and orthopedics — with Sinhala and Tamil language support, quick e-visa processing, and world-class hospitals in Chennai and Bangalore.',
...
const maldives: CountryMetadata = {
  ...
  recommendedCities: [
    ...
    {
      name: 'Kochi',
      flightTime: '1.5 hours from Male',
      directFlights: true,
      airlines: ['IndiGo'],
      specialties: ['Cardiac', 'General surgery', 'Orthopedics'],
    },
  ...
  heroSubtitle:
    'Direct flights from Male. Visa on arrival. English-speaking coordinators. Save 50–70% vs Singapore. Trusted by 600+ Maldivian families.',
  metaDescription:
    'Affordable medical treatment in India for Maldivian patients. Visa on arrival, English support, save 50–70% on cardiac, cancer, orthopedic care at JCI hospitals. Free consultation.',
  introParagraph:
    'Patients from Male and across the Maldives travel to India for cardiac surgery, cancer treatment, orthopedics, and transplants — benefiting from visa-on-arrival access, direct flights, and world-class hospitals at significantly lower costs than Singapore.',
