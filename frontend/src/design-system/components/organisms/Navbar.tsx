...
const Navbar = React.forwardRef<HTMLElement, NavbarProps>(
  ({ className, brand, links, cta: _cta, locale, currentPath, localeFallbacks, phoneNumber, callLabel, whatsappHref, whatsappLabel, ...props }, ref) => {
      ...
      >
        ...
        >
          ...
          >
            ...
            <span
              className={cn(
                'transition-all duration-500 ease-out-expo lg:opacity-100 lg:max-w-none lg:translate-x-0',
                scrolled
                  ? 'max-w-0 opacity-0 translate-x-1 lg:max-w-none lg:opacity-100 lg:translate-x-0'
          ...
          <div className="flex items-center gap-1.5 md:gap-3">
            ...
            {phoneNumber && (
              <a
                ...
                className="flex items-center gap-1.5 rounded-full border border-ink/20 bg-cream-100 px-2.5 py-1 text-xs font-semibold text-ink transition-colors hover:border-ink/40 hover:bg-cream-200 md:px-3 md:py-1.5 md:text-sm"
            ...
            {whatsappHref && (
              <a
                ...
                className="hidden items-center gap-1.5 rounded-pill bg-ink px-4 py-2 text-sm font-semibold text-white no-underline transition-all hover:bg-ink/90 hover:text-white hover:shadow-lg hover:shadow-ink/30 lg:inline-flex"
              >
        ...
        {open && (
          <div className="absolute top-full left-4 right-4 mt-2 rounded-2xl bg-white shadow-lg lg:hidden">
              ...
              {whatsappHref && (
                <li className="pt-2">
                  <a
                    ...
                    rel="noopener noreferrer"
                    onClick={() => setOpen(false)}
                    className="flex items-center justify-center gap-2 rounded-pill bg-ink px-4 py-3 text-sm font-semibold text-white no-underline transition-all hover:bg-ink/90 hover:text-white hover:shadow-lg hover:shadow-ink/30"
                  >
