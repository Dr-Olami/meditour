...
export type { FooterProps, FooterLegalLink } from './Footer';
export { LanguageSwitcher } from './LanguageSwitcher';
export type { LanguageSwitcherProps } from './LanguageSwitcher';
export { LeadForm } from './LeadForm';
export type { LeadFormProps } from './LeadForm';
export { LeadFormModal } from './LeadFormModal';
export type { LeadFormModalProps } from './LeadFormModal';
export { LeadModalTrigger } from './LeadModalTrigger';
export type { LeadModalTriggerProps } from './LeadModalTrigger';
...
export type { WhyUsSectionProps, WhyUsItem } from './WhyUsSection';